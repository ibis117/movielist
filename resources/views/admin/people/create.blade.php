    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header">{{ __('Create People') }}</div>
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{ route('people.store') }}" method="post" class="row">
                            @csrf
                            ...
                            <div class="mb-3 col-md-12">
                                ...
                                <textarea name="overview" id="" cols="20" rows="6" class="form-control" placeholder="Write a Bio"></textarea>
                            </div>
